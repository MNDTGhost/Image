...
extern void MNDT::DrawPoint8bit(const Image& image, const Point& point, C_UCHAE& color)
{
...
extern void MNDT::DrawRect24bit(const Image& image, const Rect& rect, Pixel& color)
{
